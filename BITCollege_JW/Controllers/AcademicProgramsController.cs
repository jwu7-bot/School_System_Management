...
namespace BITCollege_JW.Controllers
{
    public class AcademicProgramsController : Controller
    {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            //*** The Clear method to clear the relatioship between the Academic Program
            //    object to be deleted and the corresponding Student and Course records so
            //    when a program is deleted, we don’t delete the related Student or Course records 
