...
namespace Utility
{
    ...
    public static class BusinessRules
    {
        ...
        /// <returns>The appropriate error message corresponding to the errorCode.</returns>
        public static string RegisterError(int errorCode)
        {
            switch (errorCode)
            {
                case -100: return "Student cannot register for a course in which there is already an ungraded registration.";
                case -200: return "Student has exceeded maximum attempts on mastery course.";
                case -300: return "An error has occurred while updating the registration.";
        ...
        /// <param name="parseAtIndex">The index of the string o begin parsing</param>
